...
def run_test_problem1a():
    ...
    # Test 3:
    expected = -0.484
    print_expected_result_of_test([10, 50], expected, test_results,
                                  format_string)
    ...
    # Test 4:
    expected = -1.873
    print_expected_result_of_test([20, 70], expected, test_results,
                                  format_string)
    actual = problem1a(20, 70)
    print_actual_result_of_test(expected, actual, test_results, precision=3)
...
def run_test_problem1b():
    ...
    # Test 3:
    expected = 49
    answer = problem1b(10, 25)
    print('Test 3 expected:', expected)
    print('actual:', answer)
    # Test 4:
    expected = 58
    answer = problem1b(10, 30)
